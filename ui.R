        ...
        tabItem(tabName = "zoom",
                ...
                fluidRow(
                  box(title="Filter parameters",status="primary",width = 12,solidHeader = T,collapsible = T,
                      ...
                      fluidRow(
                        column(4, 
                               p(HTML("<b>Normalization option</b>"),span(shiny::icon("info-circle"), id = "info_nor"),radioButtons('norm_option', 
                                                                                                                                    label = NULL,
                                                                                                                                    choiceNames = list("Median+GC correction","Average Mom&Dad"),
                                                                                                                                    choiceValues = list("MedGC","BiP")))),
                        column(4, 
